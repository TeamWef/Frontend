...
class ChattingService {
  socket = new sockJS(`${process.env.REACT_APP_SOCKET_URL}/socket`);
  ...
  onConnect = (roomAddress = "/socket", headers = {}, callback = () => {}) => {
    let newMessage = "";
    // headers에 {} 인증요청 집어 넣기
  ...
  sendMessage = (messageObject, headers = {}) => {
    this.stompClient.send("/socket", {}, JSON.stringify(messageObject));
